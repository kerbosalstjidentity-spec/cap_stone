...
def main() -> None:
    ...
    p.add_argument("--rules", type=Path, default=PROJECT_ROOT / "policies" / "fds" / "rules_v1.yaml")
    p.add_argument("--thresholds", type=Path, default=PROJECT_ROOT / "policies" / "fds" / "thresholds_v1.yaml")
