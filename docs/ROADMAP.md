...
- [x] **W3-#5** sign_count=0 처리 + 역행 시 클론 탐지 동작 — `02_FIDO2:362` — [중/보안] — ✅ tbd (2026-05-02)
- [x] **W3-#6** 감사 디스크 I/O 백그라운드 워커 분리 — `16_블록체인:364` — [중/인프라] — ✅ 3a511c6 (2026-05-02)
- [x] **W3-#7** 패스키 분실 백업 코드 발급/소진 흐름 — `02_FIDO2:381` + `threat/01:79` — [중/UX] — ✅ tbd (2026-05-02)
...
| 2026-05-02 | W3-#5,#7 | FIDO2 sign_count 클론 탐지 + 백업 코드 발급/소진 | tbd |
