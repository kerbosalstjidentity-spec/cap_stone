...
- [x] **W1-#5** ABAC 엔진 ↔ ABE 미들웨어 wiring (8가지 룰 런타임 연결) — `15_ABAC_ABE:512` — [상/보안] — ✅ tbd (2026-05-02)
- [ ] **W1-#6** 클라이언트 시그널 HMAC 서명 + 서버사이드 보강 — `14_행동_시그널:191` — [상/보안]
- [x] **W1-#7** 403 응답에서 `required_policy`/`your_attributes` 마스킹 (운영 모드) — `15_ABAC_ABE:513` — [하/보안] — ✅ tbd (2026-05-02)
...
| 2026-05-02 | W1-#5,#7 | ABAC 엔진 wiring + 403 응답 마스킹 (production) | tbd |
