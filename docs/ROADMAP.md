...
- [x] **W2-#3** 행동 시그널 DeviceStore → Redis sorted set + TTL — `14_행동_시그널:189` — [중/인프라] — ✅ tbd (2026-05-02)
...
| 2026-05-02 | W2-#3 | DeviceStore Redis sorted set + TTL | tbd |
