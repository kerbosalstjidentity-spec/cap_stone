...
- [x] **W1-#2** JWT 블랙리스트 메커니즘 (jti 기반, 로그아웃·계정잠금 시 무효화) — `perspectives/threat/01:77` — [상/보안] — ✅ tbd (2026-05-02)
...
| 2026-05-02 | W1-#2 | JWT 블랙리스트 (jti + Redis) + /v1/auth/logout + refresh 회전 | tbd |
