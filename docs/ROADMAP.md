...
- [x] **W6-#8** ORDER BY random() → TABLESAMPLE BERNOULLI 최적화 — `20_학습:157` — [중/백엔드] — ✅ tbd (2026-05-10)
...
| 2026-05-10 | W6-#8 | TABLESAMPLE 절 헬퍼 (`trainer._random_sample_clause` PostgreSQL BERNOULLI(pct) 생성, target/total*100*2.5 0.1~50% 안전 클립, ML_TABLESAMPLE_DISABLE env, 비-PG 자동 폴백) + 5 PASS | tbd |
