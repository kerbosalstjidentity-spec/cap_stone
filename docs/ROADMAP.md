...
| **W6.5** | **FDS 강화: 그래프 + 비용 가중 (P1, 신설)** | **7** | **4** | **57%** |
...
- [x] **W6.5-#4** 다단계 자금세탁 룰 (`LayeringRule`) — `13-Track A` 부분 — [중/백엔드] — ✅ tbd (2026-05-05)
...
| 2026-05-05 | W6.5-#4 | LayeringRule (체인 패턴, fan_in<3 ∧ pass_through≥0.9 ∧ recent_inbound≤10min → REVIEW) + sender_recent_inbound_min_ago 피처 | tbd |
