...
- [x] **W9-#9** 08_카테고리 ingest 경로 wiring + 키워드 우선순위 문서화 — `08_카테고리_자동_분류:157,159` — [하/백엔드] — ✅ tbd (2026-05-09)
...
| 2026-05-09 | W9-#9 | 카테고리 ingest 경로 wiring (_autoclassify_if_other in spend_profile_db) + 키워드 우선순위 docstring 명시 (삽입 순서) + 6 PASS | tbd |
