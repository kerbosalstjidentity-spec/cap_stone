...
- [x] **W1-#3** JWT HS256 → RS256 전환 + kid 헤더 다중 키 라우팅 — `perspectives/threat/01:76` + `01_기본인증:214` — [상/보안] — ✅ tbd (2026-05-02)
- [x] **W1-#4** ABE 마스터 시크릿 미설정 시 fail-fast 기동 중단 — `15_ABAC_ABE:517` — [하/보안] — ✅ tbd (2026-05-02)
...
| 2026-05-02 | W1-#3 | JWT HS256↔RS256 양립 + kid 다중 키 라우팅 | tbd |
| 2026-05-02 | W1-#4 | ABE/JWT 시크릿 production fail-fast | tbd |
