...
- [x] **W9-#4** 13_룰엔진 `window_minutes` 기본값 5로 조정 — `13_규칙_엔진:249` — [하/백엔드] — ✅ tbd (2026-05-09)
...
| 2026-05-09 | W9-#4 | VelocityRule window_minutes 기본 10→5 (profile.velocity 키 1m/5m/15m 정합화, 회귀 21 PASS) | tbd |
