...
- [x] **W7.5-#3** 시간대 외 거래 군집 탐지 (사용자별 평균 활동 시간 학습) — 신규 — [중/ML] — ✅ tbd (2026-05-07)
...
| 2026-05-07 | W7.5-#3 | OffHoursClusterRule (UserProfile.hour_histogram + 미사용시간대 REVIEW / ≤5% SOFT_REVIEW, ACCOUNT_TAKEOVER 매핑, InMemory/Redis 양쪽 노출) + 10 PASS | tbd |
