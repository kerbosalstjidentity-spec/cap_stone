...
- [x] **W5.5-#4** fraud-service 입력 스키마 PaySim 정합화 + `_normalize_anomaly` 재튜닝 — `12-Track 1` — [중/ML] — ✅ tbd (2026-05-05)
...
| 2026-05-05 | W5.5-#4 | fraud-service PaySim 스키마 정합화 (features/ensemble/routes_score 도메인 분기 + ANOMALY_RANGES 재튜닝) | tbd |
