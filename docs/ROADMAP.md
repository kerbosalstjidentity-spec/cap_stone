...
| **W5.5** | **FDS 강화: PaySim 도메인 확장 (P1, 신설)** | **7** | **1** | **14%** |
...
- [x] **W5.5-#1** 시나리오 시뮬레이터 4종 (보이스피싱/머니뮬/계정탈취/카드테스팅) — `12-Track 2` — [중/ML] — ✅ tbd (2026-05-05)
...
| 2026-05-05 | W5.5-#1 | 시나리오 시뮬레이터 4종 + /v1/scenario/run 검출률 집계 라우터 + 7개 테스트 | tbd |
