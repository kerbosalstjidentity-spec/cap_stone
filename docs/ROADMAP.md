...
- [x] **W9-#2** 22_평가 `compliance_rate` → `production_ready_rate` KeyError 수정 — `22_모델_평가:160` — [하/백엔드] — ✅ tbd (2026-05-09)
...
| 2026-05-09 | W9-#2 | evaluation_suite.py 'compliance_rate' KeyError 수정 (실제 키 production_ready_rate 로 print 2곳 교체) | tbd |
