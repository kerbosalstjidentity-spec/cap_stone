...
- [x] **W2-#6** 소비 프로필/추천 store → DB — `05_KMeans:240` + `10_추천:254` — [중/인프라] — ✅ tbd (2026-05-02)
...
| 2026-05-02 | W2-#6 | spend_profile DB 재수화 (lifespan startup) | tbd |
