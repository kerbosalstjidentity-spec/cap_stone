...
- [x] **W3-#3** Genesis 블록 환경변수/마이그레이션 박제 — `16_블록체인:360` — [하/인프라] — ✅ tbd (2026-05-02)
- [x] **W3-#4** `_save()` 전체 재직렬화 → JSONL append-only로 O(1)화 — `16_블록체인:358` — [상/인프라] — ✅ tbd (2026-05-02)
- [ ] **W3-#5** sign_count=0 처리 + 역행 시 클론 탐지 동작 — `02_FIDO2:362` — [중/보안]
- [x] **W3-#6** 감사 디스크 I/O 백그라운드 워커 분리 — `16_블록체인:364` — [중/인프라] — ✅ tbd (2026-05-02)
...
- [x] **W9-#14** 16_블록체인 싱글턴 환경변수 오버라이드 — `16_블록체인:369` — [하/인프라] — ✅ tbd (2026-05-02)
...
| 2026-05-02 | W3-#3,#4,#6 + W9-#14 | 감사 체인 Genesis 박제·JSONL append·백그라운드 writer·env path | tbd |
